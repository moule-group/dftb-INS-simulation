...
# Updation 7/16/24: Adding DFT-D3 dispersion correction 
...
def relax(kPoints,geometry,temp,fmax,disp=False):
    ...
    if not disp:
        ...
        calc = Dftb(label="relax", 
                ...
                Hamiltonian_Dispersion_Damping_a1='3.6017',
...
def runDFTB(kPoints=[1,1,1],sc=[2,2,2],geometry=None,temp=5,fmax=1e-3,mode=None,disp=False):
...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--dispersion", action='store_false', help="Dispersion correction (DFT-D3)") # Add an argument: dispersion 
    args = parser.parse_args() # Parse the argument
    runDFTB(kPoints=args.kpoints,mode=args.mode,sc=args.supercell,fmax=args.fmax,disp=args.dispersion)
